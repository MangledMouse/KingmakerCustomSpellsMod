    ...
    public class NewSpells
    {
        ...
        public static void createHeightenedAwareness()
        {
            ...
            var skill_buff = Helpers.CreateBuff("HeightenedAwarenessSkillBuff",
                                                ...
                                                "You are in a heightened state of awareness. You receive a +2 competence bonus on all Perception, Knowledge and Lore checks. You may dismiss this bonus to receive a +4 bonus to initiative checks for 3 rounds.",
